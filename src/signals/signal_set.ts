...
export class SignalSet<V> implements Set<V> {
  #wrappedSet: Set<V>;
  ...
  entries(): IterableIterator<[V, V]> {
    observe(this, FULL_SET_FIELD);
    return new SignalIterableIterator<[V, V]>(this.#wrappedSet.entries());
  }
  keys(): IterableIterator<V> {
    observe(this, FULL_SET_FIELD);
    return new SignalIterableIterator<V>(this.#wrappedSet.keys());
  }
  values(): IterableIterator<V> {
    observe(this, FULL_SET_FIELD);
    return new SignalIterableIterator<V>(this.#wrappedSet.values());
  }
